...
public class RemoteControlPrac {

	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);

		AirConditionionerPrac air = new AirConditionionerPrac();
		TelevisionPrac tv = new TelevisionPrac();
		LightPrac lg = new LightPrac();
		...
		while(boo == true) {
			...
			case 1: // 에어컨 메뉴
				while(true) {
					airMessage();
					System.out.println("현재 온도: " + air.i);
			...
			case 2: // 티비 메뉴
				while(true) {
					...
					if(selectMenu2 == 1) {
						tv.powerOn(tv.i);
						System.out.println("현재 채널 및 볼륨: " + tv.i + "채널 / " + "볼륨: " + tv.volumn);
					} else if (selectMenu2 == 3) {
						tv.changeChannelUp(tv.i);
					} else if (selectMenu2 == 4) {
						tv.changeChannelDown(tv.i);
			...
			case 3: // 전등 메뉴
				while(true) {
					...
					if(selectMenu3 == 1) {
						System.out.println("현재 밝기 레벨: " + lg.i);
						lg.powerOn(lg.i);
					} else if(selectMenu3 == 3) {
						lg.lightLevelUp(lg.i);
					} else if(selectMenu3 == 4) {
						lg.lightLevelDown(lg.i);
